 ...
 * O CÓDIGO ESTÁ MUITO MAL OTIMIZADO
 * SINTA-SE AVONTADE PARA MELHORÁ-LO
 * EXISTEM MUITOS OBJETOS REDUNDANTES E MUITA MEMÓRIA GASTA ATOA
 * FUNCIONA 100% E ATÉ ENTÃO NÃO TIVE ERROS
 */
...
public class DataCubeStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public enum Field 
	{
		INPUT_DIMENSAO1_FIELD_NAME,
		INPUT_DIMENSAO2_FIELD_NAME,
		INPUT_DIMENSAO3_FIELD_NAME,
		INPUT_DIMENSAO4_FIELD_NAME,
		INPUT_DIMENSAO5_FIELD_NAME,
		INPUT_DIMENSAO6_FIELD_NAME,
		INPUT_DIMENSAO7_FIELD_NAME,
		INPUT_DIMENSAO8_FIELD_NAME,
		INPUT_DIMENSAO9_FIELD_NAME,
		INPUT_DIMENSAO10_FIELD_NAME,
		INNER_KEEP_INPUT_VALUE,
		OUTPUT_SAIDA_FIELD_NAME,
		OUTPUT_TESTE_FIELD_NAME,
		OUTPUT_CABECALHO1_FIELD_NAME,
		OUTPUT_CABECALHO2_FIELD_NAME,
		OUTPUT_CABECALHO3_FIELD_NAME,
		OUTPUT_CABECALHO4_FIELD_NAME,
		OUTPUT_CABECALHO5_FIELD_NAME,
		OUTPUT_CABECALHO6_FIELD_NAME,
		OUTPUT_CABECALHO7_FIELD_NAME,
		OUTPUT_CABECALHO8_FIELD_NAME,
		OUTPUT_CABECALHO9_FIELD_NAME,
		OUTPUT_CABECALHO10_FIELD_NAME,
		OUTPUT_CABECALHO11_FIELD_NAME,
		
		OUTPUT_STRUCTUREDEFINITION1_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION2_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION3_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION4_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION5_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION6_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION7_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION8_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION9_FIELD_NAME,
		OUTPUT_STRUCTUREDEFINITION10_FIELD_NAME,
		
		OUTPUT_LABEL1_FIELD_NAME,
		OUTPUT_LABEL2_FIELD_NAME,
		OUTPUT_LABEL3_FIELD_NAME,
		OUTPUT_LABEL4_FIELD_NAME,
		OUTPUT_LABEL5_FIELD_NAME,
		OUTPUT_LABEL6_FIELD_NAME,
		OUTPUT_LABEL7_FIELD_NAME,
		OUTPUT_LABEL8_FIELD_NAME,
		OUTPUT_LABEL9_FIELD_NAME,
		OUTPUT_LABEL10_FIELD_NAME,
	}
...
//		}
	...
	public void loadXML(Node stepDomNode, List<DatabaseMeta> databases,
		...
		inputDimensao1 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO1_FIELD_NAME.name());
		inputDimensao2 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO2_FIELD_NAME.name());
		inputDimensao3 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO3_FIELD_NAME.name());
		inputDimensao4 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO4_FIELD_NAME.name());
		inputDimensao5 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO5_FIELD_NAME.name());
		inputDimensao6 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO6_FIELD_NAME.name());
		inputDimensao7 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO7_FIELD_NAME.name());
		inputDimensao8 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO8_FIELD_NAME.name());
		inputDimensao9 = XMLHandler.getTagValue(stepDomNode,
                Field.INPUT_DIMENSAO9_FIELD_NAME.name());
		inputDimensao10 = XMLHandler.getTagValue(stepDomNode,
		...
		outputSaida = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_SAIDA_FIELD_NAME.name());
		outputTeste = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_TESTE_FIELD_NAME.name());
		cabecalho1 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO1_FIELD_NAME.name());
		cabecalho2 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO2_FIELD_NAME.name());
		cabecalho3 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO3_FIELD_NAME.name());
		cabecalho4 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO4_FIELD_NAME.name());
		cabecalho5 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO5_FIELD_NAME.name());
		cabecalho6 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO6_FIELD_NAME.name());
		cabecalho7 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO7_FIELD_NAME.name());
		cabecalho8 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO8_FIELD_NAME.name());
		cabecalho9 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO9_FIELD_NAME.name());
		cabecalho10 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO10_FIELD_NAME.name());
		cabecalho11 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_CABECALHO11_FIELD_NAME.name());
		
		structureDefinition1 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION1_FIELD_NAME.name());
		structureDefinition2 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION2_FIELD_NAME.name());
		structureDefinition3 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION3_FIELD_NAME.name());
		structureDefinition4 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION4_FIELD_NAME.name());
		structureDefinition5 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION5_FIELD_NAME.name());
		structureDefinition6 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION6_FIELD_NAME.name());
		structureDefinition7 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION7_FIELD_NAME.name());
		structureDefinition8 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_STRUCTUREDEFINITION8_FIELD_NAME.name());
		structureDefinition9 = XMLHandler.getTagValue(stepDomNode,
		...
		label1 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL1_FIELD_NAME.name());
		label2 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL2_FIELD_NAME.name());
		label3 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL3_FIELD_NAME.name());
		label4 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL4_FIELD_NAME.name());
		label5 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL5_FIELD_NAME.name());
		label6 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL6_FIELD_NAME.name());
		label7 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL7_FIELD_NAME.name());
		label8 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL8_FIELD_NAME.name());
		label9 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL9_FIELD_NAME.name());
		label10 = XMLHandler.getTagValue(stepDomNode,
                Field.OUTPUT_LABEL10_FIELD_NAME.name());
	...
	public String getXML() throws KettleException {
		...
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO1_FIELD_NAME.name(), inputDimensao1));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO2_FIELD_NAME.name(), inputDimensao2));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO3_FIELD_NAME.name(), inputDimensao3));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO4_FIELD_NAME.name(), inputDimensao4));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO5_FIELD_NAME.name(), inputDimensao5));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO6_FIELD_NAME.name(), inputDimensao6));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO7_FIELD_NAME.name(), inputDimensao7));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO8_FIELD_NAME.name(), inputDimensao8));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO9_FIELD_NAME.name(), inputDimensao9));
		xml.append(XMLHandler.addTagValue(
                Field.INPUT_DIMENSAO10_FIELD_NAME.name(), inputDimensao10));
        xml.append(XMLHandler.addTagValue(Field.INNER_KEEP_INPUT_VALUE.name(),
                innerKeepInputFields));
		
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_SAIDA_FIELD_NAME.name(), outputSaida));
		
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO1_FIELD_NAME.name(), cabecalho1));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO2_FIELD_NAME.name(), cabecalho2));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO3_FIELD_NAME.name(), cabecalho3));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO4_FIELD_NAME.name(), cabecalho4));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO5_FIELD_NAME.name(), cabecalho5));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO6_FIELD_NAME.name(), cabecalho6));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO7_FIELD_NAME.name(), cabecalho7));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO8_FIELD_NAME.name(), cabecalho8));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO9_FIELD_NAME.name(), cabecalho9));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO10_FIELD_NAME.name(), cabecalho10));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_CABECALHO11_FIELD_NAME.name(), cabecalho11));
		
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION1_FIELD_NAME.name(), structureDefinition1));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION2_FIELD_NAME.name(), structureDefinition2));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION3_FIELD_NAME.name(), structureDefinition3));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION4_FIELD_NAME.name(), structureDefinition4));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION5_FIELD_NAME.name(), structureDefinition5));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION6_FIELD_NAME.name(), structureDefinition6));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION7_FIELD_NAME.name(), structureDefinition7));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION8_FIELD_NAME.name(), structureDefinition8));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION9_FIELD_NAME.name(), structureDefinition9));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_STRUCTUREDEFINITION10_FIELD_NAME.name(), structureDefinition10));
		
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL1_FIELD_NAME.name(), label1));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL2_FIELD_NAME.name(), label2));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL3_FIELD_NAME.name(), label3));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL4_FIELD_NAME.name(), label4));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL5_FIELD_NAME.name(), label5));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL6_FIELD_NAME.name(), label6));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL7_FIELD_NAME.name(), label7));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL8_FIELD_NAME.name(), label8));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL9_FIELD_NAME.name(), label9));
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_LABEL10_FIELD_NAME.name(), label10));
					
		xml.append(XMLHandler.addTagValue(
	            Field.OUTPUT_TESTE_FIELD_NAME.name(), outputTeste));
	...
	public void readRep(Repository repository, ObjectId stepIdInRepository,
        ...
        inputDimensao1 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO1_FIELD_NAME.name());
        inputDimensao2 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO2_FIELD_NAME.name());
        inputDimensao3 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO3_FIELD_NAME.name());
        inputDimensao4 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO4_FIELD_NAME.name());
        inputDimensao5 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO5_FIELD_NAME.name());
        inputDimensao6 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO6_FIELD_NAME.name());
        inputDimensao7 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO7_FIELD_NAME.name());
        inputDimensao8 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO8_FIELD_NAME.name());
        inputDimensao9 = repository.getStepAttributeString(stepIdInRepository,
                Field.INPUT_DIMENSAO9_FIELD_NAME.name());
        ...
        outputSaida = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_SAIDA_FIELD_NAME.name());    
        
        cabecalho1 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO1_FIELD_NAME.name());  
        cabecalho2 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO2_FIELD_NAME.name()); 
        cabecalho3 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO3_FIELD_NAME.name()); 
        cabecalho4 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO4_FIELD_NAME.name()); 
        cabecalho5 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO5_FIELD_NAME.name()); 
        cabecalho6 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO6_FIELD_NAME.name()); 
        cabecalho7 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO7_FIELD_NAME.name()); 
        cabecalho8 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO8_FIELD_NAME.name()); 
        cabecalho9 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO9_FIELD_NAME.name()); 
        cabecalho10 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO10_FIELD_NAME.name()); 
        cabecalho11 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_CABECALHO11_FIELD_NAME.name()); 
        ...
        label1 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL1_FIELD_NAME.name()); 
        label2 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL2_FIELD_NAME.name()); 
        label3 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL3_FIELD_NAME.name()); 
        label4 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL4_FIELD_NAME.name()); 
        label5 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL5_FIELD_NAME.name()); 
        label6 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL6_FIELD_NAME.name()); 
        label7 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL7_FIELD_NAME.name()); 
        label8 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL8_FIELD_NAME.name()); 
        label9 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL9_FIELD_NAME.name()); 
        label10 = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_LABEL10_FIELD_NAME.name()); 
             
        outputTeste = repository.getStepAttributeString(stepIdInRepository,
                Field.OUTPUT_TESTE_FIELD_NAME.name());    
	...
	public void getFields(RowMetaInterface inputRowMeta, String name,
        ...
        addValueMeta(inputRowMeta, outputTeste,
