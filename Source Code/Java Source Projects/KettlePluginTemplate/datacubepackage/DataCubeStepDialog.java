...
public class DataCubeStepDialog extends BaseStepDialog implements StepDialogInterface {
	...
	private Control buildContents(Control lastControl, ModifyListener defModListener) {
        ...
        item.setText("Definição das dimensões");
        Composite cpt = swthlp.appendComposite(wTabFolder, lastControl);

        wOutputSaida = swthlp.appendTextVarRow(cpt,
        		wOutputSaida, "URI do tipo da Medida",
                defModListener);
        
        wInputDimensao1	= appendComboVar(wOutputSaida, defModListener, cpt, "Dimensão 1");
        
        wInputDimensao2 = appendComboVar(wInputDimensao1, defModListener,
        		cpt," Dimensão 2");
        wInputDimensao3 = appendComboVar(wInputDimensao2, defModListener,
        		cpt, "Dimensão 3");
        wInputDimensao4 = appendComboVar(wInputDimensao3, defModListener,
        		cpt, "Dimensão 4");
        wInputDimensao5 = appendComboVar(wInputDimensao4, defModListener,
        		cpt, "Dimensão 5");
        wInputDimensao6 = appendComboVar(wInputDimensao5, defModListener,
        		cpt, "Dimensão 6");
        wInputDimensao7 = appendComboVar(wInputDimensao6, defModListener,
        		cpt, "Dimensão 7");
        wInputDimensao8 = appendComboVar(wInputDimensao7, defModListener,
        		cpt, "Dimensão 8");
        wInputDimensao9 = appendComboVar(wInputDimensao8, defModListener,
        		cpt, "Dimensão 9");
        wInputDimensao10 = appendComboVar(wInputDimensao9, defModListener,
        		cpt, "Medida");
        item.setControl(cpt); 
        ...
        item.setText("Definição dos vocabulários");
        cpt = swthlp.appendComposite(wTabFolder, lastControl);
        
        cabecalho1 = swthlp.appendTextVarRow(cpt,
        		cabecalho1, "@base",
                defModListener);
        
        cabecalho2 = swthlp.appendTextVarRow(cpt,
        		cabecalho1, "@prefix owl:",
                defModListener);
        
        cabecalho3 = swthlp.appendTextVarRow(cpt,
        		cabecalho2, "@prefix rdf:",
                defModListener);
        
        cabecalho4 = swthlp.appendTextVarRow(cpt,
        		cabecalho3, "@prefix rdfs:",
                defModListener);
        
        cabecalho5 = swthlp.appendTextVarRow(cpt,
        		cabecalho4, "@prefix dc:",
                defModListener);
        
        cabecalho6 = swthlp.appendTextVarRow(cpt,
        		cabecalho5, "@prefix skos:",
                defModListener);
        
        cabecalho7 = swthlp.appendTextVarRow(cpt,
        		cabecalho6, "@prefix sdmx_code:",
                defModListener);
        
        cabecalho8 = swthlp.appendTextVarRow(cpt,
        		cabecalho7, "@prefix sdmx_dimension:",
                defModListener);
        
        cabecalho9 = swthlp.appendTextVarRow(cpt,
        		cabecalho8, "@prefix cube:",
                defModListener);
        
        cabecalho10 = swthlp.appendTextVarRow(cpt,
        		cabecalho9, "@prefix ex:",
                defModListener);
        
        cabecalho11 = swthlp.appendTextVarRow(cpt,
        		cabecalho10, "@prefix exProp:",
                defModListener);
        item.setControl(cpt);
        
        //Criação de tab   
        item = new CTabItem(wTabFolder, SWT.NONE);
        item.setText("Definir a estrutura de cada dimensão (URIs)");
        cpt = swthlp.appendComposite(wTabFolder, lastControl);
        
        
        structureDefinition1 = swthlp.appendTextVarRow(cpt,
        		structureDefinition1, "URI da primeira dimensão escolhida",
                defModListener);
        structureDefinition2 = swthlp.appendTextVarRow(cpt,
        		structureDefinition1, "URI da segunda dimensão escolhida",
                defModListener);
        structureDefinition3 = swthlp.appendTextVarRow(cpt,
        		structureDefinition2, "URI da terceira dimensão escolhida",
                defModListener);
        structureDefinition4 = swthlp.appendTextVarRow(cpt,
        		structureDefinition3, "URI da quarta dimensão escolhida",
                defModListener);
        structureDefinition5 = swthlp.appendTextVarRow(cpt,
        		structureDefinition4, "URI da quinta dimensão escolhida",
                defModListener);
        structureDefinition6 = swthlp.appendTextVarRow(cpt,
        		structureDefinition5, "URI da sexta dimensão escolhida",
                defModListener);
        structureDefinition7 = swthlp.appendTextVarRow(cpt,
        		structureDefinition6, "URI da sétima dimensão escolhida",
                defModListener);
        structureDefinition8 = swthlp.appendTextVarRow(cpt,
        		structureDefinition7, "URI da oitava dimensão escolhida",
                defModListener);
        structureDefinition9 = swthlp.appendTextVarRow(cpt,
        		structureDefinition8, "URI da nona dimensão escolhida",
                defModListener);
        structureDefinition10 = swthlp.appendTextVarRow(cpt,
        		structureDefinition9, "URI da medida",
                defModListener);
        item.setControl(cpt);
        ...
        //Criação de tab   
        item = new CTabItem(wTabFolder, SWT.NONE);
        item.setText("Labels de cada Dimensão usada");
        cpt = swthlp.appendComposite(wTabFolder, lastControl);
        label1 = swthlp.appendTextVarRow(cpt,
        		label1, "Label da primeira dimensão",
                defModListener);
        
        label2 = swthlp.appendTextVarRow(cpt,
        		label1, "Label da segunda dimensão",
                defModListener);
        
        label3 = swthlp.appendTextVarRow(cpt,
        		label2, "Label da terceira dimensão",
                defModListener);
        
        label4 = swthlp.appendTextVarRow(cpt,
        		label3, "Label da quarta dimensão",
                defModListener);
        
        label5 = swthlp.appendTextVarRow(cpt,
        		label4, "Label da quinta dimensão",
                defModListener);
        
        label6 = swthlp.appendTextVarRow(cpt,
        		label5, "Label da sexta dimensão",
                defModListener);
        
        label7 = swthlp.appendTextVarRow(cpt,
        		label6, "Label da sétima dimensão",
                defModListener);
        
        label8 = swthlp.appendTextVarRow(cpt,
        		label7, "Label da oitava dimensão",
                defModListener);
        
        label9 = swthlp.appendTextVarRow(cpt,
        		label8, "Label da nona dimensão",
                defModListener);
        
        label10 = swthlp.appendTextVarRow(cpt,
        		label9, "Label da medida",
                defModListener);
        ...
        wInnerKeepInput = swthlp.appendCheckboxRow(wOutputGroup, wOutputGroup,"Visualisar os campos do CSV (não realiza a transformação)",
        ...
        wOutputTeste = swthlp.appendTextVarRow(wOutputGroup, wOutputSaida,"Teste",
               defModListener);
