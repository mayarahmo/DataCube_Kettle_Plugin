...
if "%PENTAHO_DI_JAVA_OPTIONS%"=="" set PENTAHO_DI_JAVA_OPTIONS="-Xmx1024m" "-XX:MaxPermSize=256m"
...
start "Spoon" "%_PENTAHO_JAVA%" %OPT% %DEBUG%
-jar launcher\launcher.jar -lib ..\%LIBSPATH% %_cmdline%
